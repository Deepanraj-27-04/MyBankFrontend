                ...
                <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                     ...
                     <div>
                        ...
                        <input type="tel" placeholder="+1 (555) 123-4567" className="mt-1 block w-full px-4 py-2 bg-gray-50 dark:bg-slate-700 border border-gray-300 dark:border-slate-600 rounded-lg" />
                    </div>
