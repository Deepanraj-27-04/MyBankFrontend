  ...
  return (
    <Card className="flex flex-col justify-between">
      <div>
        ...
        <p className={`text-3xl sm:text-4xl font-bold ${balanceColor}`}>
    ...
    <>
      <div className="space-y-6">
        <div className="flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center">
          <h2 className="text-2xl sm:text-3xl font-bold">Your Accounts</h2>
          <Button onClick={() => setIsModalOpen(true)} className="w-full sm:w-auto">Add New Account</Button>
        </div>
