    ...
    <div className="flex items-center justify-center min-h-screen">
      <div className="w-full max-w-md p-8 space-y-8 bg-white dark:bg-slate-800 rounded-2xl shadow-lg">
          <div className="text-center">
            ...
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">Welcome to PQR Bank</h1>
          ...
          <form className="space-y-6" onSubmit={handleLogin}>
           ...
           <div className="text-center text-sm text-gray-500 dark:text-gray-400">
              <p>
                  ...
                  <ReactRouterDOM.Link to="/register" className="font-medium text-primary hover:text-primary-500">
                    Sign up now
                  </ReactRouterDOM.Link>
              </p>
              <p className="mt-2">
                  Are you an administrator?{' '}
                  <ReactRouterDOM.Link to="/admin/login" className="font-medium text-primary hover:text-primary-500">
                      Admin Login
                  </ReactRouterDOM.Link>
              </p>
           </div>
